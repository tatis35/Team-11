...
public class C03_StringSayiToplama {
    ...
    public static void main(String[] args) {
        ...
        double str1Sayi = Double.valueOf(str1);  //parseDouble de zailabilir valueof yerine
        double str2Sayi = Double.valueOf(str2);  //parseDouble de zailabilir valueof yerine
